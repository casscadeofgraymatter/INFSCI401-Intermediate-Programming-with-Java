...
public class Module2Assignment {
    ...
    static ArrayList<Integer>sortArrayList(ArrayList<Integer>array) {   // this method is worth 100pts
        int lowest;
        ...
        // Create a simple loop to travel the whole arraylist(see printarray to borrow one)
        {
          ArrayList<Integer> sorted = new ArrayList<Integer>();
            ...
            int target = array.indexOf(lowest);
              sorted.add(lowest);
    ...
    static int findlowest(ArrayList<Integer> array) {   // This method is worth 50pts
